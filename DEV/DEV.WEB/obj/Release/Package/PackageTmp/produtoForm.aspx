<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DefaultMaster.Master" CodeBehind="produtoForm.aspx.cs" Inherits="DEV.WEB.produtoForm" %>
...
<asp:Content runat="server" class="formulario" ContentPlaceHolderID="ContentMain">
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group col-md-5">
                    <label for="inputEmail4">Preco em R$:</label>
                    <asp:TextBox ID="txtValor" class="form-control" runat="server" placeholder="Valor"></asp:TextBox>
                </div>
            </div>
             <div class="form-row">
                <div class="form-group col-md-5">
                    <label for="inputEmail4">Quantidade em Estoque:</label>
